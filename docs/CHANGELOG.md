...
- 🐞 Fixes consume `--help` flag, removes `--develop` and updates `--input` to accept latest release keywords ([#745](https://github.com/ethereum/execution-spec-tests/pull/745)).
